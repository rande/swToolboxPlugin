...
/*
 * This file is part of the swToolboxPlugin package.
 * (c) Thomas Rabaix <thomas.rabaix@soleoweb.com>
 *   adapted from the work of Fabien Potencier <fabien.potencier@symfony-project.com>
 * 
...
EOF
  ...
  {
    return array('/swToolboxPlugin/js/autocompleter/jquery.autocompleter.css' => 'print');
  }
  ...
  {
    return array('/swToolboxPlugin/js/autocompleter/jquery.autocompleter.js');
  }
}
